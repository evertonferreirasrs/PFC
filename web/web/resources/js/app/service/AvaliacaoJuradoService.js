class AvaliacaoJuradoService{
    readByEstande(estande) {
        return new Promise((resolve, reject) => {
            let xhr = new XMLHttpRequest();

            xhr.open('GET', Configuration.getUrl() + "avaliacaoJurado?estande="+estande);
    ...
    readAll() {
        return new Promise((resolve, reject) => {
            ...
            xhr.open('GET', Configuration.getUrl() + "avaliacaoJurado");
    ...
    delete(id) {
        return new Promise((resolve, reject) => {
            ...
            xhr.open('DELETE', Configuration.getUrl() + "avaliacaoJurado/"+id);
