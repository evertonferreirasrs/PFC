        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="page-title">
                    <div>
                        <h1><i class="fa fa-university"></i> Beacons</h1>
                ...
                <div class="row">
                    <div class="col-xs-12 text-right">
                        <a href="<c:url value="/beacon/adicionar" />" class="btn btn-primary">Adicionar Beacon</a><br><br>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body" id="table-beacons">
