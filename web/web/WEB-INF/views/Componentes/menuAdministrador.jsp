...
<!-- Navbar-->
<header class="main-header hidden-print"><a class="logo" href="<c:url value="/gerenciador"/>"><img src="<c:url value="/resources/img/logos/logo5.png"/>" alt="LocalizaÊ" class="img-responsive"></a>
            ...
            <ul class="top-nav">
                ...
                <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-lg"></i></a>
                    <ul class="dropdown-menu settings-menu">
                        ...
                        <li><a href="<c:url value="/"/>"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<aside class="main-sidebar hidden-print">
    <section class="sidebar">
        <div class="user-panel">
            <div class="pull-left image"><img src="<c:url value="/resources/img/icon.ico"/>" alt="LocalizaÊ" class="img-responsive img-circle"></div>
